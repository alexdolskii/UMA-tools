"""Exercise Python processing, filtering, and cleanup without Java."""
...
class PythonAnalysisTests(unittest.TestCase):
    ...
    def test_missing_input_does_not_start_java(self):
        for module, function in (
            (alignment, alignment.main_fibronectin_processing),
    ...
    def test_thickness_disposes_imagej_after_error(self):
        ...
        with (
            patch.object(
                thickness, "get_folder_paths", return_value=["images"]
            ),
