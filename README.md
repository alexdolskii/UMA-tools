...
The current Python package version is **0.2.6**; this is separate from the V2
...
The latest modular refactor preserves the established calculations, units,
parameters, and output columns. Current alignment uses OrientationPy; the
historical OrientationJ approach is linked below. Old script paths remain
...
An environment already set up for 0.2.5 needs no dependency changes for 0.2.6.
